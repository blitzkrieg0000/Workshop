...
from deep_sort import iou_matching, kalman_filter, linear_assignment
...
class Tracker():
    ...
    def _match(self, detections):
        ...
        # Trackları onaylanmış ve onaylanmamış olarak ayır
        confirmed_tracks = [i for i, t in enumerate(self.tracks) if t.is_confirmed()]
        unconfirmed_tracks = [i for i, t in enumerate(self.tracks) if not t.is_confirmed()]

        # Görünüm özelliklerini kullanarak onaylanmış trackleri ilişkilendirin(association).
        ...
        # IOU(Intersection Over Unit) kullanarak kalan trackleri doğrulanmamış parçalarla ilişkilendirin(association)
